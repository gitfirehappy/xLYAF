...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(TMPro.TMP_Text p0, string p1)
		{
		...
		public void __Gen_Delegate_Imp1(TMPro.TMP_Text p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(UnityEngine.UI.Image p0, string p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp3(TMPro.TMP_Text p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp4()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLua.LuaTable __Gen_Delegate_Imp5()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
...
>>>>>>> parent of 9d7f8d7 (gitignore更新)
		...
		public void __Gen_Delegate_Imp23(object p0, object p1, int p2, Point p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaDelegateConfig.Action_TMP_Text_string))
			{
			    return new LuaDelegateConfig.Action_TMP_Text_string(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaDelegateConfig.Action_TMP_Text))
			{
			    return new LuaDelegateConfig.Action_TMP_Text(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(LuaDelegateConfig.Action_Image_string))
			{
			    return new LuaDelegateConfig.Action_Image_string(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(LuaDelegateConfig.Action_TMP_Text_int))
			{
			    return new LuaDelegateConfig.Action_TMP_Text_int(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(LuaDelegateConfig.Action_return_Vector3))
			{
			    return new LuaDelegateConfig.Action_return_Vector3(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(System.Func<XLua.LuaTable>))
			{
			    return new System.Func<XLua.LuaTable>(__Gen_Delegate_Imp5);
			}
